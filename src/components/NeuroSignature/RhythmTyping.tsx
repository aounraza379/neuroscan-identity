      ...
      <div className="glassmorphism rounded-lg p-4 space-y-3">
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-background/50 border border-border rounded-lg px-4 py-3 font-mono text-sm 
        ...
        <div className="h-1 bg-muted rounded-full overflow-hidden">
          <motion.div
            ...
            style={{
              backgroundColor: isMatch ? 'hsl(var(--primary))' : 'hsl(var(--muted-foreground))',
            }}
            initial={{ width: 0 }}
        ...
        <div className="flex justify-between text-xs font-mono text-muted-foreground">
          ...
          <span>{isMatch ? 'COMPLETE' : 'IN PROGRESS'}</span>
        </div>
      </div>
    </motion.div>
  );
